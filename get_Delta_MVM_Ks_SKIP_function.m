function [K_latlon_horizontal_mvm_function, K_latlon_vertical_mvm_function] = get_Delta_MVM_Ks_SKIP_function(W_lat_x, W_lon_x, covg_lat, covg_lon, W_lat_z, W_lon_z, tol_eval_latlon, num_evals_taken, number_of_passes)
