function [U_linearlatlon, D_linearlatlon, V_linearlatlon] = get_SVD_Ks_Rectangular_Linear_SKIP_function(W_lat_x, W_lon_x, covg_lat, covg_lon, W_lat_z, W_lon_z, linear_vector_x, linear_vector_z, tol_eval_latlon, num_evals_taken, number_of_passes, flag_GPU)

%% Gets a low-rank decomposition of rectangular covariance matrix K using SKIP with linear term
...
[U_linearlatlon, D_linearlatlon, V_linearlatlon] = Fast_SVD_Rectangular_function(K_linearlatlon_horizontal_mvm_function, K_linearlatlon_vertical_mvm_function, ...
    num_cols, num_evals_taken, number_of_passes);
