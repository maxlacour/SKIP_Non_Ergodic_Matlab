function [U_sorted, D_sorted, V_sorted] = Fast_SVD_Improved_function(K, n, k, number_of_passes, method)

if strcmp(method, 'Lanczos') == 1

    K_Lanczos = @(x, t_flag) K(x);
    
    [U_sorted, D_small, V_sorted] = svds(K_Lanczos, [n, n], k);
...
%%% Using Algorithm 5.1 from Halko 2011!!
